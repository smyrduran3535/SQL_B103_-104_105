...
CREATE TABLE workers (
	...
	ALTER TABLE workers ADD workers_address VARCHAR(80);
...
select*from companies where number_of_employees=10000; --hardcoding

select*from companies where number_of_employees=
(select min(number_of_employees) from companies);   
